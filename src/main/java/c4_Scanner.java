...
public class c4_Scanner {
    static void main(String[] args) {
      ...
      //  System.out.println();
        ...
        System.out.printf(" EmployeeID: %d %n EmployeeName: %s %n%n BasicSalary: %s %n Bonus: %s %n%n GrossSalary: %s %n TaxAmount: %s %n NetSalary: %s %n%n Married: %s  %n"
                , EmployeeID , EmployeeName , BasicSalary , Bonus  , GrossSalary , TaxAmount , NetSalary , Married  );
